...
const file_api_helloworld_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/helloworld/helloworld.proto\x12\x0eapi.helloworld\"\x19\n" +
	...
	"\x0eListHelloworld\x12%.api.helloworld.ListHelloworldRequest\x1a#.api.helloworld.ListHelloworldReplyB9\n" +
	"\x0eapi.helloworldP\x01Z%server-demo/api/helloworld;helloworldb\x06proto3"

var (
	file_api_helloworld_helloworld_proto_rawDescOnce sync.Once
	file_api_helloworld_helloworld_proto_rawDescData []byte
)

func file_api_helloworld_helloworld_proto_rawDescGZIP() []byte {
	file_api_helloworld_helloworld_proto_rawDescOnce.Do(func() {
		file_api_helloworld_helloworld_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_helloworld_helloworld_proto_rawDesc), len(file_api_helloworld_helloworld_proto_rawDesc)))
	})
...
var file_api_helloworld_helloworld_proto_goTypes = []any{
...
func file_api_helloworld_helloworld_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_helloworld_helloworld_proto_rawDesc), len(file_api_helloworld_helloworld_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
